// =============================================================
// 🔍 BUSCADOR DE TABLA — sólo en páginas con #buscadorTabla y #lista
// =============================================================
document.addEventListener("DOMContentLoaded", function () {
  ...
  function filtrarTabla() {
    ...
    if (filtro === "") {
      tbody.innerHTML = "";
      rowCache.forEach(r => { r.el.style.display = ""; tbody.appendChild(r.el); });
      ownReload = true;
      document.dispatchEvent(new Event("tableReady"));
      return;
    }

    rowCache.forEach(r => { if (!tbody.contains(r.el)) tbody.appendChild(r.el); });
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    const res  = await fetch(base + "/Notificaciones/getNotificaciones");
    ...
    pieLi.innerHTML = `
      ...
      <a class="dropdown-item text-center small text-primary py-2" href="${base}/home/index">
        Ver todas
      </a>`;
...
// =============================================================
// 👤 PERFIL — sin guard, corre en TODAS las páginas
// =============================================================
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function loadProfile() {
    ...
    try {
      const base = typeof RUTA_URL !== "undefined" ? RUTA_URL : "";
      const res  = await fetch(`${base}/user/getUser?id=${userId}`, {
      ...
      document.getElementById("profileRolVisible").value = user.rol ?? "";
      document.getElementById("profileRolHidden").value  = user.rol ?? "";
